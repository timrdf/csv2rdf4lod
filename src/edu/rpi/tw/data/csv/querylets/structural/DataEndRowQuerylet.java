 ...
 * 
 */
public class DataEndRowQuerylet extends RowQuerylet {

   public DataEndRowQuerylet(Resource context) {
      super(context);
   }
   ...
   public String getQueryString(Resource context) {
      ...
      String graphPattern = "?s \n"+
                            "     conversion:enhance [ ov:csvRow ?rowNum; a conversion:DataEndRow ] .";
      String orderBy      = "";
