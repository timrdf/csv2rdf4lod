...
public class SDMX {
   ...
   public static final String     BASE_URI = "http://purl.org/linked-data/cube#";
   ...
   public static final Namespace namespace = new NamespaceImpl("sdmx",BASE_URI);
   ...
   public static final URI DimensionProperty = vf.createURI(R, "DimensionProperty");
}